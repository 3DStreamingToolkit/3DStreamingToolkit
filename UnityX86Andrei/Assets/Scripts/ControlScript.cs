...
#region Graphics Low-Level Plugin DLL Setup
    ...
    void Awake()
    {
        ...
        // Local Dev Setup
        //ServerInputTextField.text = "signalingserver.centralus.cloudapp.azure.com:8888";
    }
...
#region Virtual Camera Control
    ...
    private void CreateTextureAndPassToPlugin()
    {
        ...
        // leftImage.transform.localScale = new Vector3(-1f, (float)textureHeight / textureWidth, 1f) * 2f;
        // rightImage.transform.localScale = new Vector3(-1f, (float)textureHeight / textureWidth, 1f) * 2f;
        ...
        tex.Apply();
        leftImage.GetComponent<RawImage>().texture = tex;
        rightImage.GetComponent<RawImage>().texture = tex;
