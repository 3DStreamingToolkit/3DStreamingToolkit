...
public class consoleBillboard : MonoBehaviour
{

    public Camera m_Camera;
    public Fractals rootFractal;
    ...
    void Update()
    {
        ...
        var buildString = "FRACTAL DEPTH: [" + rootFractal.maxDepth + "  RECURSIONS ]    ";
        ...
        if (isHL)
        {
            ...
            buildString += "  | Camera Position: " + m_Camera.transform.localPosition.ToString();
