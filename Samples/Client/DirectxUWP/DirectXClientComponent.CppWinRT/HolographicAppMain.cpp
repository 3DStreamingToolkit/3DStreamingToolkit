...
void HolographicAppMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
	...
	m_locatabilityChangedToken = m_locator.LocatabilityChanged(std::bind(&HolographicAppMain::OnLocatabilityChanged, this, _1, _2));
	...
	m_cameraAddedToken =
		m_holographicSpace.CameraAdded(std::bind(&HolographicAppMain::OnCameraAdded, this, _1, _2));
	...
	m_cameraRemovedToken =
		m_holographicSpace.CameraRemoved(std::bind(&HolographicAppMain::OnCameraRemoved, this, _1, _2));
...
bool HolographicAppMain::Render(
	HolographicFrame const& holographicFrame,
	int fps,
	int latency)
{
	//
...
void HolographicAppMain::OnLocatabilityChanged(SpatialLocator const& sender, ::winrt::Windows::Foundation::IInspectable const& args)
{
		...
		// Holograms cannot be rendered.
	{
		winrt::hstring message = L"Warning! Positional tracking is " +
			winrt::to_hstring(static_cast<int32_t>(sender.Locatability())) + L".\n";
