...
public class PeerConnectionClient {
  ...
  public PeerConnectionClient() {
    rootEglBase = EglBase$$CC.create$$STATIC$$();
  }
  ...
  public void createPeerConnection(final VideoRenderer.Callbacks remoteRender,
                                   final SignalingParameters signalingParameters) {
    createPeerConnection(Collections.singletonList(remoteRender), signalingParameters);
  }
  ...
  public void createPeerConnection(final List<VideoRenderer.Callbacks> remoteRenders,
                                   final SignalingParameters signalingParameters) {
    if (peerConnectionParameters == null) {
      Log.e(TAG, "Creating peer connection without initializing factory.");
      return;
