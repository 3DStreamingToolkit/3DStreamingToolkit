...
import microsoft.a3dtoolkitandroid.ServerListFragment.OnListFragmentInteractionListener;
...
public class ServerListRecyclerViewAdapter extends RecyclerView.Adapter<ServerListRecyclerViewAdapter.ViewHolder> {
    ...
    public ServerListRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
