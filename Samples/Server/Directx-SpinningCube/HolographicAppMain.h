...
namespace Toolkit3DSample
{
    ...
    {
    public:
        HolographicAppMain(DX::DeviceResources* deviceResources);
        ~HolographicAppMain();
    ...
    private:
		...
		// Renders a colorful holographic cube that's 20 centimeters wide.
		// This sample content is used to demonstrate world-locked rendering.
