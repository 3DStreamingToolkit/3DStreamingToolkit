...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	// Initializes viewport for left and right cameras.
	g_CameraResources.SetViewport(1280, 720);
	...
	void* pUserContext)
{
	...
	V_RETURN(DXUTCompileFromFile(L"Multithreaded_VS.hlsl", nullptr, "VSMain", "vs_4_0",
		D3DCOMPILE_ENABLE_STRICTNESS, 0, &pVertexShaderBuffer));

	ID3DBlob* pPixelShaderBuffer = nullptr;
	V_RETURN(DXUTCompileFromFile(L"Multithreaded_PS.hlsl", nullptr, "PSMain", "ps_4_0",
