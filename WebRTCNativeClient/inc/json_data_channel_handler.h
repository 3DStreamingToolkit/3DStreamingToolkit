/*
*  JsonDataChannelHandler applies mouse and keyboard messages to calculate the
...
class JsonDataChannelHandler : public DataChannelHandler
{
public:
	JsonDataChannelHandler();
	~JsonDataChannelHandler();
